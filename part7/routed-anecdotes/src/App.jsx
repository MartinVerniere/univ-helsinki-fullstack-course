...
import { useField } from './hooks/AnecdotesHooks'
...
const Anecdote = ({ anecdote }) => {
  return (
    <div>
      <h2>Anecdote</h2>
      <div><h3>Title:</h3> {anecdote.content}</div>
      <div><h3>Author:</h3> {anecdote.author}</div>
      <div><h3>URL:</h3> {anecdote.info}</div>
      <h2>---</h2>
    </div>
  )
}
...
const CreateNew = (props) => {
  ...
  const { onReset: resetInfo, ...info } = useField('url')
